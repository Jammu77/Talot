...
weaponStorage = function(id)
    ...
    ESX.TriggerServerCallback('krisu_housing:getInventory', function(inv)
        local elements = {}
    ...
    function(data, menu)
        if data.current.value == 's' then
            ...
            ESX.TriggerServerCallback('krisu_housing:getInventory', function(inv)
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'storeItem', {
                    ...
                    TriggerServerEvent('krisu_housing:storeItem', 'weapon', data2.current.weapon, data2.current.ammo, id)
                    menu2.close()
        ...
        elseif data.current.value == 'w' then
            ...
            ESX.TriggerServerCallback('krisu_housing:getHouseInv', function(inv)
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'withdrawItem', {
                    ...
                    TriggerServerEvent('krisu_housing:withdrawItem', 'weapon', data2.current.weapon, data2.current.ammo, id)
                    menu2.close()
                end, function(data2, menu2)
                    menu2.close()
                end)
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'storeItem', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('krisu_housing:storeItem', data2.current.type, data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'withdrawItem', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('krisu_housing:withdrawItem', 'item', data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
